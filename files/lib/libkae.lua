--[[ Common functions for interactive Lua experimentation (SAFE MODE)

This is a copy of libkae.lua with unsafe (io, debug) code removed. This
version is intended for use by Noita mods that don't have access to
unsafe modules.
